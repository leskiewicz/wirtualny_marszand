...
router.post('/pictures/:id/edit', artystaController.edit_picture_post);
...
router.post('/sale/pictures/:id/remove', artystaController.remove_sale_picture_post);

router.get('/archive/pictures', artystaController.all_archive_pictures_get);
router.get('/archive/pictures/:id', artystaController.one_archive_picture_get);
