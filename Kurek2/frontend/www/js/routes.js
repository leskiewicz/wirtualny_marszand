...
var routes = [
  ...
  {
    path: '/artist/pictures/:pid/edit',
    url: './pages/artist/pictures/artistEditPicture.html',
  },
  ...
  {
    path: '/artist/archive/pictures',
    url: './pages/artist/archive/artistArchivePictures.html',
  },

  {
    path: '/artist/archive/pictures/:pid/show',
    url: './pages/artist/archive/artistShowArchivePicture.html',
  },
  ...
  {
    path: '/hotel/archive/pictures',
    url: './pages/hotel/archive/hotelArchivePictures.html',
  },

  {
    path: '/hotel/archive/pictures/:pid/show',
    url: './pages/hotel/archive/hotelShowArchivePicture.html',
  },
