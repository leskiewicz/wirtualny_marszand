...
let artistCombined = artistSales+artistPictures;
//ARTIST
...
let hotelCombined = hotelSale+hotelPictures+hotelShop;
//HOTEL
...
$(document).on('page:init', '.page[data-name="hotelShowSale"]', async function (e, page) {
  ...
  $('#image').attr('src', respMe2.imageLocation);
  $('#qrcode').attr('src', respMe2.qrCodeLocation);
  $('#percentage').text(respMe2.percentage + '% z ' + respMe2.additionalPrice);
