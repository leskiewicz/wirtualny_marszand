...
router.get('/pictures', hotelController.all_pictures_get);
router.get('/pictures/:id', hotelController.one_picture_get);
router.post('/pictures/:id/sell', hotelController.picture_on_sale_post);

router.get('/sale/pictures', hotelController.all_pictures_sale_get);
router.get('/sale/pictures/:id', hotelController.one_picture_sale_get);

router.get('/shop/pictures', hotelController.all_pictures_shop_get);
router.get('/shop/pictures/:id', hotelController.one_picture_shop_get);
router.post('/shop/pictures/:id/buy', hotelController.buy_artist_picture_post);
router.post('/sale/pictures/:id/remove', hotelController.remove_sale_picture_post);

router.get('/archive/pictures', hotelController.all_archive_pictures_get);
router.get('/archive/pictures/:id', hotelController.one_archive_picture_get);
/*
...
*/
router.get('/transactions', hotelController.show_history_get)
router.get('/transactions/:id', hotelController.show_history_one_get)
